...
class DeliveryMapView extends StatefulWidget {
  final void Function(bool isInDeliveryArea, LatLng? location, String? address)? onLocationSelected;
...
class _DeliveryMapViewState extends State<DeliveryMapView> {
  ...
  Future<void> _onMapTapped(LatLng position) async {
    ...
    if (widget.onLocationSelected != null) {
      widget.onLocationSelected!(isInDeliveryArea, selectedLocation, selectedAddress);
    }
  }
