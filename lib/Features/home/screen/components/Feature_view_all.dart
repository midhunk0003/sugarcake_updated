...
import '../../controller/feature_viewall_controller.dart';

import '../../model/get_feature_product_model.dart';

class FeatureViewAllScreen extends StatelessWidget {
  FeatureViewAllScreen({
    super.key,
  });

  final FeatureProductController myController =
  Get.put(FeatureProductController());
      ...
      body: SafeArea(
        child: PopScope(
          ...
          if (myController.isLoading.value) {
            ...
            final List<FeaturedproductsList>? products =
                myController.getFeatureProductsModel.value.featuredproductsList;
              ...
              return SingleChildScrollView(
                child: Column(
                  children: <Widget>[
                    ...
                    Obx(() {
                      final List<FeaturedproductsList>? displayedProducts =
                      myController.searchBool.value
                          ? myController.wishlistList
                          : products;
